...
function getCreationFormTemplate(cardId) {
    return `
        <div style="display: flex; flex-direction: column; gap: 12px; width: 100%; height: 100%; padding: 16px; box-sizing: border-box; background-color: #15151f; border-left: 1px solid #2A2A33;">
            ...
            <button id="insta-snipe-${cardId}" style="padding: 10px 12px; border: none; background-color: #be185d; color: white; border-radius: 4px; cursor: pointer; font-weight: 600; font-size: 14px; text-align: center; width: 100%; margin-top: 8px;">Insta-Snipe Top Suggestion</button>
